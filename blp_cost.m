...
Xv = [const hpwt weight space suv truck van minivan];
Kv = size(Xv,2);
...
Zv = [Xzv pgreal cafestd.*comply count_firm/10 Z_firm_v count_total/1000 Z_rival_v];
...
Zc = [Xzc log(gpm) trend/10 count_firm/10 Z_firm_c count_total/1000 Z_rival_c];
